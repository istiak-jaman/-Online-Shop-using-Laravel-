...
<body>
	...
	<div class="navbar">
		<div class="navbar-inner">
			<div class="container-fluid">
				...
				<a class="brand " href="index.html"><span class="font-weight-bold">Online Shop</span></a>
					...
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li>
							...
							<ul>
								...
								<li><a class="submenu" href="{{URL::to('/all-sliders')}}"><i class="icon-file-alt"></i><span class="hidden-tablet"> All Slider</span></a></li>
	...
	<!-- start: JavaScript-->
		...
		<script type="text/javascript" href="https://cdnjs.cloudflare.com/ajax/libs/bootbox.js/5.4.0/bootbox.min.js"></script>
	{{-- <script>
